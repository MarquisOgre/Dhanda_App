        ...
        <div className="metric-card">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold">₹4,85,200</p>
            </div>
          </div>
        </div>
        <div className="metric-card">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">This Month Purchase</p>
              <p className="text-xl font-bold">₹2,85,400</p>
            </div>
          </div>
        </div>
        <div className="metric-card">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-success">₹1,99,800</p>
            </div>
          </div>
        </div>
        <div className="metric-card">
