  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Taxes Report (GST & TCS/TDS)</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="metric-card">
          ...
          <p className="text-2xl font-bold mt-2 text-primary">₹{totalTDS.toLocaleString()}</p>
        </div>
        <div className="metric-card">
          <div className="flex items-center justify-between">
      ...
      <Tabs defaultValue="gst" className="space-y-6">
        <TabsList>
          ...
          <TabsTrigger value="tcs">TCS/TDS Details</TabsTrigger>
        </TabsList>
